...
- Не выполнялась отдельная фильтрация ботов и автоматического трафика.
- Категории анализируются без разворачивания полной иерархии `parentid → categoryid`.
- Анализ показывает наблюдаемые зависимости и не позволяет самостоятельно установить причинно-следственные связи.
